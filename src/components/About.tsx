...
export default function About() {
  return (
    <div className="max-w-7xl px-0 py-16 gap-13 flex flex-col abt">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-30 items-start">
        ...
        <main className="md:col-span-3 relative top-10 left-5 gap-10 flex flex-col">
